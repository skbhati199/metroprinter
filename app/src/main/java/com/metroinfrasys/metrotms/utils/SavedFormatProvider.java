    ...
    class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String cpcl = "^XA" +
                    ...
                    "^FO10,30^FD===================================^FS" +
                    "^CF0,30" +
                    "^FO50,50^FDToll Plaza Name: KM-42 Manesar^FS" +
                    "^CF0,22" +
                    "^FO50,70^FD ^FS" +
                    "^FO50,100^FDReceipt No.: ^FS" +
                    "^FO50,130^FDTC Name: r45r^FS" +
                    "^FO50,160^FDLane No.: 52^FS" +
                    "^FO50,190^FDJourney Type : Single Journey^FS" +
                    "^FO50,220^FDTC Class : MAV^FS" +
                    "^FO50,250^FDFare : Rs. 100^FS" +
                    "^FO50,280^FDDate & Time : 21-Jan-2019 10:15:05 AM^FS" +
                    "^FO10,300^FD==================================^FS" +
                    "^FX Third section with barcode." +
                    "^BY4,3,90" +
                    "^FO50,340^BC^FD12345678^FS" +
                    "^XZ";
            ;
            ...
            db.execSQL("INSERT INTO " + SavedFormat.TABLE_NAME + "(" + SavedFormat._ID + ", " +
                    ...
                    SavedFormat.FORMAT_TEXT + ", " +
                    SavedFormat.TIMESTAMP + ") " +
                    "VALUES (3, 'E:', 'ZPL Data', '.ZPL', 'Sample', '" + cpcl + "', 1350426632404)"
            );
        }
